...
public class StaffPerformanceTable extends JTable implements ActionListener {
   
    private final JButton print;
    private static final Color panelColor = new Color(199, 159, 79);
    
    public StaffPerformanceTable(String[][] data, String[] headers, JButton print) throws SQLException{
        super(data, headers);
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            writer = PdfWriter.getInstance(document, new FileOutputStream("Staff_Performance_Report.pdf"));
            document.open();
