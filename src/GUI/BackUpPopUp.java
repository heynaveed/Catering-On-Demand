 ...
 * @author Naveed PC
 */
public class BackUpPopUp extends javax.swing.JFrame {
    ...
    public BackUpPopUp(String whatHappened) {
        initComponents();
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        this.setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
        jLabelWhatHappened.setText(whatHappened);
    ...
    private void initComponents() {
        ...
        jLabelWhatHappened = new javax.swing.JLabel();
        ...
        jLabelWhatHappened.setText("jLabel1");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(113, 113, 113)
                        .addComponent(jLabelWhatHappened)))
    ...
    private javax.swing.JLabel jLabelWhatHappened;
